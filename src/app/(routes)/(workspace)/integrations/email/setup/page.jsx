  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        router.push('/integrations?success=email_connected');
      } else {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zinc-50 via-slate-50 to-stone-100 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12 relative z-10">
        ...
        >
          ...
          >
            ...
            >
              ...
              <motion.div
                animate={{ scale: focusedField === 'recipient' ? 1.01 : 1 }}
            ...
            >
              ...
              <motion.div
                animate={{ scale: focusedField === 'replyTo' ? 1.01 : 1 }}
                transition={{ duration: 0.2 }}
                className="relative"
              >
                <input
            ...
            >
              ...
              <div className="flex items-start gap-3 relative z-10">
                ...
                <div>
                  <p className="text-sm font-bold text-blue-900 mb-1">Sender Information</p>
        ...
        >
          <FeatureCard icon={<HiCheckCircle className="w-6 h-6" />} title="Instant Delivery" description="Get notifications in real-time" delay={1.1} />
          <FeatureCard icon={<HiLightningBolt className="w-6 h-6" />} title="Reliable" description="99.9% delivery success rate" delay={1.2} />
          <FeatureCard icon={<HiSparkles className="w-6 h-6" />} title="Customizable" description="Tailor to your preferences" delay={1.3} />
        </motion.div>
      </div>
    </div>
  );
