...
//   // ✅ NEW: Initialize Cloudflare Stream SDK
//   useEffect(() => {
//     if (!isAuthorized || !videoData) return;
...
//   // ✅ NEW: Handle seeking from comment timestamps
...
//   // Helper: Extract Iframe URL
//   const getIframeUrl = (url) => {
//     if (!url) return '';
//     const match = url.match(/cloudflarestream\.com\/([a-zA-Z0-9]+)\//);
//     const id = match ? match[1] : null;
//     if (id) return `https://iframe.videodelivery.net/${id}?preload=true&autoplay=true&api=true`; // ✅ Added &api=true
//     return url; 
//   };
...
import { motion } from 'framer-motion';
import PublicVideoPlayer from '@/app/components/video/PublicVideoPlayer';
