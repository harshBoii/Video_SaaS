...
//   // ✅ Debug logging
//   useEffect(() => {
//     console.log('[VIDEO PLAYER] Mounted with video:', {
//       id: video.id,
//       title: video.title,
//       streamId: video.streamId,
...
//   // ✅ Extract streamId from playbackUrl if not present
//   useEffect(() => {
//     if (!activeStreamId && video.playbackUrl) {
//       console.log('[VIDEO PLAYER] Extracting streamId from playbackUrl:', video.playbackUrl);
//       const streamIdMatch = video.playbackUrl.match(/\/([a-f0-9]{32})\/|\/([a-f0-9]{32})$/);
//       if (streamIdMatch) {
//         const extractedId = streamIdMatch[1] || streamIdMatch[2];
//         console.log('[VIDEO PLAYER] Extracted streamId:', extractedId);
//         setActiveStreamId(extractedId);
//       }
//     }
//   }, [video.playbackUrl, activeStreamId]);
...
//         .then(res => res.json())
//         .then(data => setCtas(data.ctas || []))
//         .catch(err => console.error('[VIDEO PLAYER] Failed to fetch CTAs:', err));
//     }
//   }, [video?.id]);
...
//   // ✅ Show error state if no streamId available
//   if (!activeStreamId) {
//     console.error('[VIDEO PLAYER] No streamId available for video:', video.id);
//     return (
...
//           <p className="text-gray-400 mb-1">This video is still processing or the stream ID is missing</p>
//           <p className="text-gray-500 text-sm mb-6">Video ID: {video.id}</p>
//           <button 
//             onClick={onClose}
...
//   const iframeUrl = `https://customer-5f6vfk6lgnhsk276.cloudflarestream.com/${activeStreamId}/iframe?api=true`;
//   console.log('[VIDEO PLAYER] Rendering with iframe URL:', iframeUrl);
