          ...
          {comment.status === 'OPEN' && (
            <>
              ...
              <ProtectedButton
                ...
                className="text-xs text-green-600 hover:text-green-700 font-medium bg-transparent border-0 shadow-none p-0 backdrop-blur-none"
              >
                Mark as Resolved
              </ProtectedButton>
            </>
              ...
              {showActions && (
                <>
                  ...
                  <motion.div
                    ...
                    className="absolute right-0 mt-1 w-48 bg-white rounded-lg shadow-xl border border-gray-200 py-1 z-20"
                  >
                    <button
                      onClick={() => {
                    ...
                    <ProtectedButton
                      ...
                      className="w-full px-4 py-2 text-left text-sm text-red-600 hover:bg-red-50 flex items-center gap-2 bg-transparent border-0 shadow-none backdrop-blur-none rounded-none"
                    >
              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1">
                  <textarea
                    ...
                    className="w-full px-0 py-1 border-0 border-b-2 border-gray-200 focus:border-blue-500 focus:ring-0 resize-none text-sm"
                    rows={2}
                  />
        ...
        {comment.replies && comment.replies.length > 0 && (
          <div className="mt-3">
            <button
              ...
              className="text-blue-600 text-sm font-medium hover:bg-blue-50 px-3 py-1.5 rounded-full transition-colors"
            >
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              exit={{ opacity: 0, y: -10 }}
              className="absolute left-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-gray-200 py-1 z-20"
            >
...
export default function CommentSection({ videoId, currentTime = null , isPublic = false }) {
  ...
  const handleResolve = async (commentId) => {
    const response = await fetch(`/api/videos/${videoId}/comments/${commentId}/resolve`, {
      method: 'PATCH',
      credentials: 'include',
    });
