...
export default function CampaignVideo({ campaign, onUpdate , campaignId }) {
  ...
  const [playingVideo, setPlayingVideo] = useState(null); // ✅ Video player state
  ...
  // ✅ NEW: Play video in modal instead of new window
                    ...
                    <td className="px-6 py-4">
                      <div className="flex gap-2">
                        ...
                        <ProtectedButton
                          ...
                          campaignId={campaignId} requiredPermissions={['Preview Video']}
                        >
                        ...
                        <ProtectedButton
                          ...
                          title="Download"
                          campaignId={campaignId} requiredPermissions={['Download Original']}
                        >
                        ...
                        <ProtectedButton
                          ...
                          title="Delete"
                          campaignId={campaignId} requiredPermissions={['Delete Video']}
                        >
