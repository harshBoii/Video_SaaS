  ...
  return (
    ...
    >
      ...
      <div className="flex gap-3 mb-3">
        <div className="w-12 h-12 bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg flex items-center justify-center border border-gray-200 flex-shrink-0">
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* Document Type Badge */}
          <p className={` mt-1 px-2 w-30 py-0.5 rounded-full text-xs font-semibold border text-center ${getFileTypeBadge(doc.documentType)}`}>
            {doc.documentType}
          </p>
        </div>
      </div>
...
export default function CampaignScripts({ campaign, onUpdate, campaignId }) {
  ...
  useEffect(() => {
    fetchDocuments();
  }, [campaign.id, page, workflowStatusFilter, documentTypeFilter, searchQuery]);
      ...
      <div className="space-y-6">
        ...
        {workflowStats && (
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3">
            <Tooltip content="Total documents in workflow">
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
            ...
            <Tooltip content="Approved documents">
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
            ...
            <Tooltip content="Completed documents">
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                    ...
                    <tr>
                      <td colSpan="6" className="px-6 py-12 text-center">
                        ...
                        <p className="text-gray-600 font-medium">
                          {searchQuery || workflowStatusFilter || documentTypeFilter
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-3">
                            ...
                            <div className="min-w-0 max-w-[200px]">
                              <Tooltip content={doc.title}>
                                <p className="font-medium text-sm text-gray-900 truncate">{doc.title.slice(0,25)}...</p>
                              </Tooltip>
                            </div>
                          </div>
                        </td>
                  ...
                  <label className="block">
                    ...
                    <div className={`border-2 border-dashed rounded-lg p-6 text-center cursor-pointer transition-colors ${
                      ...
                      <p className="text-sm font-medium text-gray-900">
                        {loading ? 'Uploading...' : 'Click to select document'}
                      </p>
                      {loading && (
                        <div className="mt-3">
